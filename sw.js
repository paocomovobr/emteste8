const CACHE_NAME = 'consulta-preco-v2';
const APP_SHELL = [
  './',
  './index.html',
  './manifest.json',
...
self.addEventListener('fetch', (event) => {
  ...
  // remessa.json muda de preço/estoque com frequência: rede primeiro, cache só
  // como reserva se o celular estiver offline no momento de abrir o app.
  if (req.url.includes('remessa.json')) {
    event.respondWith(
